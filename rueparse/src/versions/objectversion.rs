...
impl EUnrealEngineObjectUE5Version {
    pub const AUTOMATIC_VERSION: EUnrealEngineObjectUE5Version =
...
impl EUnrealEngineObjectUE4Version {
    pub const AUTOMATIC_VERSION: EUnrealEngineObjectUE4Version =
        EUnrealEngineObjectUE4Version::CORRECT_LICENSEE_FLAG;
}

#[derive(Debug)]
#[allow(non_camel_case_types)]
pub enum EUnrealEngineObjectLicenseeUEVersion {
    VER_LIC_NONE = 0,
    // - this needs to be the last line (see note below)
    // VER_LIC_AUTOMATIC_VERSION_PLUS_ONE,
    // VER_LIC_AUTOMATIC_VERSION = VER_LIC_AUTOMATIC_VERSION_PLUS_ONE - 1,
}
impl EUnrealEngineObjectLicenseeUEVersion {
    pub const VER_LIC_AUTOMATIC_VERSION: EUnrealEngineObjectLicenseeUEVersion =
        EUnrealEngineObjectLicenseeUEVersion::VER_LIC_NONE;
}
...
impl FPackageFileVersion {
    pub fn new(file_version_ue4: i32, file_version_ue5: i32) -> Self {
        Self {
            file_version_ue4,
            file_version_ue5,
        }
    }
    pub fn create_ue4_version(version: i32) -> Self {
        Self {
            file_version_ue4: version,
            file_version_ue5: 0,
        }
    }
    pub fn create_ue5_version(version: i32) -> Self {
        Self {
            file_version_ue4: 0,
            file_version_ue5: version,
        }
    }
}
